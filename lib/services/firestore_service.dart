...
class FireStoreService {
  ...
  List<Map<String, dynamic>> createFamilyList(
    ...
    demographicFamily.family.forEach((element) {
      var map = {
        ...
        'diedUpdateBy':FirebaseAuth.instance.currentUser.uid,
        'diedUpdateDate':getTime(),
 ...
 // Map familyData;
  ...
  Future<bool> updateFamily(DemographicFamily demographicFamily, String documentId) {
    Map<String, dynamic> data = {
      "CreatedBy": FirebaseAuth.instance.currentUser.uid,
      "createdDate":getTime(),
      "lastUpdateBy":FirebaseAuth.instance.currentUser.uid,
    ...
    return demographicData.doc(documentId)
        .update(data)
        .then((value) => true)
        .catchError((error) => false);
  }
